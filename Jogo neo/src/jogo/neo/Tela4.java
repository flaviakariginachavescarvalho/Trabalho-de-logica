...
public class Tela4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("dele, presta atenção como o joguinho ta massa, você escolherá um");

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Como o São Paulo é o melhor time do brasileirão decidi fazer um jogo");

        jLabel3.setBackground(new java.awt.Color(255, 255, 255));
        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("jogador de cada lado e eles vão competir entre si.");
